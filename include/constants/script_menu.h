...
// Drive Labs Multichoice selections
#define DRIVELABS_SELECTION_AREADRIVE	0
#define DRIVELABS_SELECTION_DEXDRIVE	1
#define DRIVELABS_SELECTION_TELEDRIVE	2
#define DRIVELABS_SELECTION_SHEENDRIVE	3
#define DRIVELABS_SELECTION_BERRYDRIVE	4
#define DRIVELABS_SELECTION_STATDRIVE	5
#define DRIVELABS_SELECTION_FORCEDRIVE	6
#define DRIVELABS_SELECTION_EXIT		7
#define DRIVELABS_SELECTION_COUNT		8
