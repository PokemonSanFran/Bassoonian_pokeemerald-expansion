...
const u8 gText_ExpandedPlaceholder_Brendan[] = _("Basil");
const u8 gText_ExpandedPlaceholder_May[] = _("Alyssa");
const u8 gText_EggNickname[] = _("Egg");
const u8 gText_Pokemon[] = _("Pokémon");
const u8 gText_ProfBirchMatchCallName[] = _("Prof. Spruce");
...
const u8 gText_WirelessNotConnected[] = _("Mystery Gift is currently offline.");
...
const u8 gText_DefaultNameStu[] = _("Basil");
const u8 gText_DefaultNameMilton[] = _("Basil");
const u8 gText_DefaultNameTom[] = _("Basil");
const u8 gText_DefaultNameKenny[] = _("Basil");
const u8 gText_DefaultNameReid[] = _("Basil");
const u8 gText_DefaultNameJude[] = _("Basil");
const u8 gText_DefaultNameJaxson[] = _("Basil");
const u8 gText_DefaultNameEaston[] = _("Basil");
const u8 gText_DefaultNameWalker[] = _("Basil");
const u8 gText_DefaultNameTeru[] = _("Basil");
const u8 gText_DefaultNameJohnny[] = _("Basil");
const u8 gText_DefaultNameBrett[] = _("Basil");
const u8 gText_DefaultNameSeth[] = _("Basil");
const u8 gText_DefaultNameTerry[] = _("Basil");
const u8 gText_DefaultNameCasey[] = _("Basil");
const u8 gText_DefaultNameDarren[] = _("Basil");
const u8 gText_DefaultNameLandon[] = _("Basil");
const u8 gText_DefaultNameCollin[] = _("Basil");
const u8 gText_DefaultNameStanley[] = _("Basil");
const u8 gText_DefaultNameQuincy[] = _("Basil");
const u8 gText_DefaultNameKimmy[] = _("Alyssa");
const u8 gText_DefaultNameTiara[] = _("Alyssa");
const u8 gText_DefaultNameBella[] = _("Alyssa");
const u8 gText_DefaultNameJayla[] = _("Alyssa");
const u8 gText_DefaultNameAllie[] = _("Alyssa");
const u8 gText_DefaultNameLianna[] = _("Alyssa");
const u8 gText_DefaultNameSara[] = _("Alyssa");
const u8 gText_DefaultNameMonica[] = _("Alyssa");
const u8 gText_DefaultNameCamila[] = _("Alyssa");
const u8 gText_DefaultNameAubree[] = _("Alyssa");
const u8 gText_DefaultNameRuthie[] = _("Alyssa");
const u8 gText_DefaultNameHazel[] = _("Alyssa");
const u8 gText_DefaultNameNadine[] = _("Alyssa");
const u8 gText_DefaultNameTanja[] = _("Alyssa");
const u8 gText_DefaultNameYasmin[] = _("Alyssa");
const u8 gText_DefaultNameNicola[] = _("Alyssa");
const u8 gText_DefaultNameLillie[] = _("Alyssa");
const u8 gText_DefaultNameTerra[] = _("Alyssa");
const u8 gText_DefaultNameLucy[] = _("Alyssa");
const u8 gText_DefaultNameHalie[] = _("Alyssa");
const u8 gText_ThisIsAPokemon[] = _("Now, you know what a Pokémon is, right?{PAUSE 96}\p");
...
const u8 gText_DexHoennTitle[] = _("Hanau Dex");
...
const u8 gText_DexHoennDescription[] = _("Hanau region's Pokédex");
...
const u8 gText_BirchInTrouble[] = _("Your very first Pokémon!\nWho will it be?");
...
const u8 gText_RedPokeblock[] = _("Red Ponut");
const u8 gText_BluePokeblock[] = _("Blue Ponut");
const u8 gText_PinkPokeblock[] = _("Pink Ponut");
const u8 gText_GreenPokeblock[] = _("Green Ponut");
const u8 gText_YellowPokeblock[] = _("Yellow Ponut");
const u8 gText_PurplePokeblock[] = _("Purple Ponut");
const u8 gText_IndigoPokeblock[] = _("Indigo Ponut");
const u8 gText_BrownPokeblock[] = _("Brown Ponut");
const u8 gText_LiteBluePokeblock[] = _("LiteBlue Ponut");
const u8 gText_OlivePokeblock[] = _("Olive Ponut");
const u8 gText_GrayPokeblock[] = _("Gray Ponut");
const u8 gText_BlackPokeblock[] = _("Black Ponut");
const u8 gText_WhitePokeblock[] = _("White Ponut");
const u8 gText_GoldPokeblock[] = _("Gold Ponut");
...
const u8 gText_EmptyString8[] = _("Dex No."); // Unused
...
const u8 gText_XNatureMetAtYZ[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1} nature,\nmet at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1} on {DYNAMIC 0}{DYNAMIC 5} {DYNAMIC 6}, 20{DYNAMIC 7}{DYNAMIC 1},\n{DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}.");
...
const u8 gText_TMs_Hms[] = _("TM Case");
...
const u8 gText_MenuOptionPokenav[] = _("P-Drive");
...
const u8 gText_Drive_AreaDrive[] = _("AreaDrive");
const u8 gText_Drive_DexDrive[] = _("DexDrive");
const u8 gText_Drive_TeleDrive[] = _("TeleDrive");
const u8 gText_Drive_SheenDrive[] = _("SheenDrive");
const u8 gText_Drive_BerryDrive[] = _("BerryDrive");
const u8 gText_Drive_StatDrive[] = _("StatDrive");
const u8 gText_Drive_ForceDrive[] = _("ForceDrive");
...
const u8 gText_PokenavAndBag[] = _("P-Drive And Bag");
...
const u8 gText_CheckMapOfHoenn[] = _("Check the map of the Hanau region.");
...
const u8 gText_PutAwayPokenav[] = _("Put away the P-Drive.");
...
const u8 gText_ReturnToPokenavMenu[] = _("Return to the P-Drive menu.");
...
const u8 gText_Ribbons[] = _("Ability"); // Unused
...
const u8 gText_GetsAPokeBlockQuestion[] = _(" gets a Ponut?");
...
const u8 gText_PokeblocksWithFriends[] = _("Ponuts W/Friends");
...
const u8 gText_BlenderMaxSpeedRecord[] = _("Ponut Baker\nMaximum Speed Record!");
...
const u8 gText_MenuPokenav[] = _("P-Drive");
...
const u8 gText_MenuDexNav[] = _("DexNav"); //CAN BE REMOVED LATER
const u8 gText_SafariBallStock[] = _("Venture Balls\nStock: {STR_VAR_1}");
...
const u8 gText_DexHoenn[] = _("Hanau");
...
const u8 gText_MrStoneMatchCallDesc[] = _("Professor");
const u8 gText_MrStoneMatchCallName[] = _("Dad");
...
const u8 gText_MomMatchCallDesc[] = _("Caring");
const u8 gText_WallyMatchCallDesc[] = _("{PKMN} Lover");
const u8 gText_NormanMatchCallName[] = _("Norman");
