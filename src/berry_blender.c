...
static const u8 sText_BerryBlenderStart[] = _("Starting up the Ponut Baker.\pPlease select a Berry from your Bag\nto put in the Ponut Baker.\p");
...
static const u8 sText_RunOutOfBerriesForBlending[] = _("You've run out of Berries for\nblending in the Ponut Baker.\p");
static const u8 sText_YourPokeblockCaseIsFull[] = _("Your Ponut Case is full.\p");
static const u8 sText_HasNoBerriesToPut[] = _(" has no Berries to put in\nthe Ponut Baker.");
static const u8 sText_ApostropheSPokeblockCaseIsFull[] = _("'s Ponut Case is full.\p");
