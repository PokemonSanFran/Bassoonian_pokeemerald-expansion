...
static const u16 sRivalAvatarGfxIds[][2] =
{
    ...
    {OBJ_EVENT_GFX_BASIL_UNDERWATER,       OBJ_EVENT_GFX_ALYSSA_UNDERWATER},
    {OBJ_EVENT_GFX_RIVAL_BRENDAN_FIELD_MOVE, OBJ_EVENT_GFX_RIVAL_MAY_FIELD_MOVE},
    {OBJ_EVENT_GFX_BASIL_FISHING,          OBJ_EVENT_GFX_ALYSSA_FISHING},
    {OBJ_EVENT_GFX_BASIL_WATERING,         OBJ_EVENT_GFX_ALYSSA_WATERING}
};

static const u16 sPlayerAvatarGfxIds[][2] =
{
    {OBJ_EVENT_GFX_BASIL_NORMAL,     OBJ_EVENT_GFX_ALYSSA_NORMAL},
    {OBJ_EVENT_GFX_BASIL_MACH_BIKE,  OBJ_EVENT_GFX_ALYSSA_MACH_BIKE},
    {OBJ_EVENT_GFX_BASIL_ACRO_BIKE,  OBJ_EVENT_GFX_ALYSSA_ACRO_BIKE},
    {OBJ_EVENT_GFX_BASIL_SURFING,    OBJ_EVENT_GFX_ALYSSA_SURFING},
    {OBJ_EVENT_GFX_BASIL_UNDERWATER, OBJ_EVENT_GFX_ALYSSA_UNDERWATER},
    {OBJ_EVENT_GFX_BASIL_FIELD_MOVE, OBJ_EVENT_GFX_ALYSSA_FIELD_MOVE},
    {OBJ_EVENT_GFX_BASIL_FISHING,    OBJ_EVENT_GFX_ALYSSA_FISHING},
    {OBJ_EVENT_GFX_BASIL_WATERING,   OBJ_EVENT_GFX_ALYSSA_WATERING},
};
...
static const u16 sPlayerAvatarGfxToStateFlag[2][5][2] =
{
    [MALE] =
    {
        {OBJ_EVENT_GFX_BASIL_NORMAL,     PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_BASIL_MACH_BIKE,  PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_BASIL_ACRO_BIKE,  PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_BASIL_SURFING,    PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_BASIL_UNDERWATER, PLAYER_AVATAR_FLAG_UNDERWATER},
    },
    [FEMALE] =
    {
        {OBJ_EVENT_GFX_ALYSSA_NORMAL,         PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_ALYSSA_MACH_BIKE,      PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_ALYSSA_ACRO_BIKE,      PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_ALYSSA_SURFING,        PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_ALYSSA_UNDERWATER,     PLAYER_AVATAR_FLAG_UNDERWATER},
    }
};
...
static bool8 TryPushBoulder(s16 x, s16 y, u8 direction)
{
    if (FlagGet(FLAG_SYS_USE_STRENGTH))
    {
        ...
        if (objectEventId != 16 && (gObjectEvents[objectEventId].graphicsId == OBJ_EVENT_GFX_PUSHABLE_BOULDER || gObjectEvents[objectEventId].graphicsId == OBJ_EVENT_GFX_CLEFAIRY_DOLL))
        {
...
u8 unref_GetRivalAvatarGenderByGraphicsId(u16 gfxId)
{
    ...
    case OBJ_EVENT_GFX_ALYSSA_UNDERWATER:
    case OBJ_EVENT_GFX_ALYSSA_FISHING:
    case OBJ_EVENT_GFX_ALYSSA_WATERING:
        return FEMALE;
    default:
        return MALE;
    }
...
u8 GetPlayerAvatarGenderByGraphicsId(u16 gfxId)
{
    switch (gfxId)
    {
    case OBJ_EVENT_GFX_ALYSSA_NORMAL:
    case OBJ_EVENT_GFX_ALYSSA_MACH_BIKE:
    case OBJ_EVENT_GFX_ALYSSA_ACRO_BIKE:
    case OBJ_EVENT_GFX_ALYSSA_SURFING:
    case OBJ_EVENT_GFX_ALYSSA_FIELD_MOVE:
    case OBJ_EVENT_GFX_ALYSSA_UNDERWATER:
    case OBJ_EVENT_GFX_ALYSSA_FISHING:
    case OBJ_EVENT_GFX_ALYSSA_WATERING:
        return FEMALE;
