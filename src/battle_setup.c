...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_HALEY] = REMATCH(TRAINER_GRC_JULIET_1, TRAINER_GRC_JULIET_2, TRAINER_GRC_JULIET_3, TRAINER_GRC_JULIET_4, TRAINER_GRC_JULIET_5, ROUTE104),
...
{
    CreateMaleMon(&gEnemyParty[0], SPECIES_STARLY, 4);
    ScriptContext2_Enable();
