...
static const u32 sTutorLearnsets[] =
{
	...
	[SPECIES_FINNEON_HANAUAN]       = TUTOR_LEARNSET(0),
	
	[SPECIES_LUMINEON_HANAUAN]       = TUTOR_LEARNSET(0),
	
	[SPECIES_GULPIN_HANAUAN]       = TUTOR_LEARNSET(0),
	
	[SPECIES_SWALOT_HANAUAN]       = TUTOR_LEARNSET(0),

    [SPECIES_WHISMUR_HANAUAN]       = TUTOR_LEARNSET(0),

    [SPECIES_LOUDRED_HANAUAN]       = TUTOR_LEARNSET(0),

    [SPECIES_EXPLOUD_HANAUAN]       = TUTOR_LEARNSET(0),

    [SPECIES_CROAGUNK_HANAUAN]       = TUTOR_LEARNSET(0),

    [SPECIES_TOXICROAK_HANAUAN]       = TUTOR_LEARNSET(0),
};
