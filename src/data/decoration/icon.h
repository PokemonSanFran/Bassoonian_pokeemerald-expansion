const u32 *const gDecorIconTable[][2] = 
{
    ...
    [DECOR_STARLY_DOLL]      = {NULL, NULL},
    [DECOR_SUBSTITUTE_DOLL]    = {NULL, NULL},
    [DECOR_AXEW_DOLL]     = {NULL, NULL},
    [DECOR_MIENFOO_DOLL]     = {NULL, NULL},
    [DECOR_PAWNIARD_DOLL]  = {NULL, NULL},
    [DECOR_MAREANIE_DOLL]  = {NULL, NULL},
    [DECOR_LARVESTA_DOLL]   = {NULL, NULL},
    [DECOR_CROAGUNK_DOLL] = {NULL, NULL},
    [DECOR_WHIMSICOTT_DOLL]     = {NULL, NULL},
    [DECOR_SNEASEL_DOLL]   = {NULL, NULL},
    [DECOR_PSYDUCK_DOLL]      = {NULL, NULL},
    [DECOR_MAKUHITA_DOLL]   = {NULL, NULL},
    [DECOR_TREECKO_DOLL]    = {NULL, NULL},
    [DECOR_TORCHIC_DOLL]    = {NULL, NULL},
    [DECOR_MUDKIP_DOLL]     = {NULL, NULL},
    [DECOR_MEGA_SLOWKING_DOLL]    = {NULL, NULL},
    [DECOR_WYNAUT_DOLL]     = {NULL, NULL},
    [DECOR_MEGA_DARMANITAN_DOLL]     = {NULL, NULL},
    [DECOR_WHISMUR_DOLL]    = {NULL, NULL},
    [DECOR_SPINDA_DOLL]    = {NULL, NULL},
    [DECOR_SCIZOR_DOLL]     = {NULL, NULL},
    [DECOR_REUNICLUS_DOLL]     = {NULL, NULL},
    [DECOR_GULPIN_DOLL]     = {NULL, NULL},
    [DECOR_UNUSED1_DOLL]      = {NULL, NULL},
    [DECOR_UNUSED2_DOLL]     = {NULL, NULL},
    ...
    [DECOR_STEELIX_DOLL]    = {gDecorIcon_SnorlaxDoll, gDecorIconPalette_SnorlaxDoll},
    [DECOR_MAMOSWINE_DOLL]     = {gDecorIcon_RhydonDoll, gDecorIconPalette_RhydonDoll},
    [DECOR_LUMINEON_DOLL]     = {gDecorIcon_LaprasDoll, gDecorIconPalette_LaprasDoll},
    [DECOR_TYRANITAR_DOLL]   = {gDecorIcon_VenusaurDoll, gDecorIconPalette_VenusaurDoll},
    [DECOR_METAGROSS_DOLL]  = {gDecorIcon_CharizardDoll, gDecorIconPalette_CharizardDoll},
    [DECOR_KOMMO_O_DOLL]  = {gDecorIcon_BlastoiseDoll, gDecorIconPalette_BlastoiseDoll},
    [DECOR_GOLURK_DOLL]    = {gDecorIcon_WailmerDoll, gDecorIconPalette_WailmerDoll},
    [DECOR_STOUTLAND_DOLL]   = {gDecorIcon_RegirockDoll, gDecorIconPalette_RegirockDoll},
    [DECOR_MEGA_ALTARIA_DOLL]     = {gDecorIcon_RegiceDoll, gDecorIconPalette_RegiceDoll},
    [DECOR_AVALUGG_DOLL]  = {gDecorIcon_RegisteelDoll, gDecorIconPalette_RegisteelDoll}
};
