...
static const struct TrainerMon sParty_GRC_Kayla[] = {
    {
    .iv = 0,
    .lvl = 15,
...
//To fix
static const struct TrainerMon sParty_GRC_Dave2[] = {
    {
    .iv = 0,
    .lvl = 11,
    .species = SPECIES_ZIGZAGOON,
...
//To fix
static const struct TrainerMon sParty_GRC_Dave3[] = {
    {
    .iv = 10,
    .lvl = 27,
    .species = SPECIES_LINOONE,
...
//To fix
static const struct TrainerMon sParty_GRC_Dave4[] = {
    {
    .iv = 20,
    .lvl = 30,
    .species = SPECIES_LINOONE,
...
//To fix
static const struct TrainerMon sParty_GRC_Dave5[] = {
    {
    .iv = 30,
    .lvl = 33,
    .species = SPECIES_LINOONE,
...
//To fix
static const struct TrainerMon sParty_GRC_Dave6[] = {
    {
    .iv = 40,
    .lvl = 36,
    .species = SPECIES_LINOONE,
...
static const struct TrainerMon sParty_GRC_Maxime1[] = {
    {
    .iv = 0,
    .lvl = 12,
    .species = SPECIES_HOOTHOOT,
...
//To fix
static const struct TrainerMon sParty_GRC_Maxime2[] = {
    {
    .iv = 0,
    .lvl = 27,
    .species = SPECIES_LINOONE,
...
//To fix
static const struct TrainerMon sParty_GRC_Maxime3[] = {
    {
    .iv = 0,
    .lvl = 30,
    .species = SPECIES_LINOONE,
...
//To fix
static const struct TrainerMon sParty_GRC_Maxime4[] = {
    {
    .iv = 0,
    .lvl = 33,
    .species = SPECIES_LINOONE,
...
//To fix
static const struct TrainerMon sParty_GRC_Maxime5[] = {
    {
    .iv = 0,
    .lvl = 36,
    .species = SPECIES_LINOONE,
...
static const struct TrainerMon sParty_Sidney[] = {
    ...
    .moves = {MOVE_TOXIC, MOVE_ROOST, MOVE_FIRE_FANG, MOVE_EARTHQUAKE}
    },
    {
    .iv = 250,
    .lvl = 64,
    ...
    .moves = {MOVE_DRAGON_DANCE, MOVE_FIRE_PUNCH, MOVE_DRAGON_CLAW, MOVE_EARTHQUAKE}
    },
    {
    .iv = 250,
    .lvl = 64,
    ...
    .moves = {MOVE_LIGHT_SCREEN, MOVE_REFLECT, MOVE_ICE_BEAM, MOVE_EARTH_POWER}
    },
    {
    .iv = 250,
    .lvl = 64,
	...
	.ability = ABILITY_HIDDEN,
    .moves = {MOVE_ICE_SHARD, MOVE_SUPERPOWER, MOVE_ICICLE_SPEAR, MOVE_EARTHQUAKE}
    },
    {
    .iv = 255,
    .lvl = 66,
    ...
    .moves = {MOVE_TORMENT, MOVE_STONE_EDGE, MOVE_CRUNCH, MOVE_EARTHQUAKE}
    }
};
...
static const struct TrainerMon sParty_Phoebe[] = {
    ...
    .moves = {MOVE_U_TURN, MOVE_HEAT_WAVE, MOVE_SUCKER_PUNCH, MOVE_BRAVE_BIRD}
    },
    {
    .iv = 250,
    .lvl = 64,
    ...
    .moves = {MOVE_ROOST, MOVE_THUNDER_WAVE, MOVE_DAZZLING_GLEAM, MOVE_AIR_SLASH}
    },
    {
    .iv = 250,
    .lvl = 64,
    ...
    .moves = {MOVE_ROOST, MOVE_U_TURN, MOVE_CROSS_POISON, MOVE_BRAVE_BIRD}
    },
    {
    .iv = 250,
    .lvl = 64,
    ...
    .moves = {MOVE_CALM_MIND, MOVE_ICE_BEAM, MOVE_AIR_SLASH, MOVE_PSYCHIC}
    },
    {
    .iv = 255,
    .lvl = 66,
    ...
    .moves = {MOVE_QUICK_ATTACK, MOVE_CLOSE_COMBAT, MOVE_DOUBLE_EDGE, MOVE_BRAVE_BIRD}
    }
};
...
static const struct TrainerMon sParty_Glacia[] = {
    ...
    .moves = {MOVE_SPIKES, MOVE_SHADOW_BALL, MOVE_SLUDGE_BOMB, MOVE_LEAF_STORM}
    },
    {
    .iv = 250,
    .lvl = 64,
    ...
    .moves = {MOVE_MACH_PUNCH, MOVE_ROCK_TOMB, MOVE_FORCE_PALM, MOVE_BULLET_SEED}
    },
    {
    .iv = 250,
    .lvl = 64,
    ...
    .moves = {MOVE_GIGA_DRAIN, MOVE_KNOCK_OFF, MOVE_FOCUS_BLAST, MOVE_POWER_WHIP}
    },
    {
    .iv = 250,
    .lvl = 64,
	...
	.ability = ABILITY_SLOT_1,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_INGRAIN, MOVE_LEECH_SEED, MOVE_HORN_LEECH, MOVE_LIQUIDATION}
    },
    {
    .iv = 255,
    .lvl = 66,
	...
	.ability = ABILITY_HIDDEN,
    .heldItem = ITEM_BLACK_SLUDGE,
    .moves = {MOVE_TOXIC, MOVE_SYNTHESIS, MOVE_GIGA_DRAIN, MOVE_VENOSHOCK}
    }
};
...
static const struct TrainerMon sParty_Drake[] = {
    ...
    .moves = {MOVE_SPIKY_SHIELD, MOVE_FAKE_OUT, MOVE_IRON_HEAD, MOVE_ZING_ZAP}
    },
    {
    .iv = 250,
    .lvl = 64,
	...
	.ability = ABILITY_SLOT_1,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_THUNDER_WAVE, MOVE_ICE_BEAM, MOVE_VOLT_SWITCH, MOVE_SURF}
    },
    {
    .iv = 250,
    .lvl = 64,
	...
	.ability = ABILITY_SLOT_1,
    .heldItem = ITEM_EXPERT_BELT,
    .moves = {MOVE_SURF, MOVE_FOCUS_BLAST, MOVE_HYPER_VOICE, MOVE_THUNDERBOLT}
    },
    {
    .iv = 250,
    .lvl = 64,
    ...
    .moves = {MOVE_VOLT_SWITCH, MOVE_SIGNAL_BEAM, MOVE_OVERHEAT, MOVE_SUNSPARK}
    },
    {
    .iv = 255,
    .lvl = 66,
    ...
    .moves = {MOVE_METAL_SOUND, MOVE_SIGNAL_BEAM, MOVE_FLASH_CANNON, MOVE_ZAP_CANNON}
    }
};
...
static const struct TrainerMon sParty_Brawly1[] = {
	...
	.ability = ABILITY_SLOT_2,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LIGHT_SCREEN, MOVE_THUNDER_WAVE, MOVE_SHOCK_WAVE, MOVE_MIRROR_SHOT}
    },
    {
    .iv = 100,
    .lvl = 17,
	...
	.ability = ABILITY_SLOT_1,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PROTECT, MOVE_DIG, MOVE_ROCK_TOMB, MOVE_IRON_HEAD}
    },
    {
    .iv = 200,
    .lvl = 19,
...
static const struct TrainerMon sParty_Wattson1[] = {
	...
	.ability = ABILITY_SLOT_1,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SOFT_BOILED, MOVE_TOXIC, MOVE_CHARM, MOVE_ECHOED_VOICE}
    },
    {
    .iv = 220,
    .lvl = 24,
	...
	.ability = ABILITY_SLOT_1,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROAR, MOVE_DIG, MOVE_CRUNCH, MOVE_RETALIATE}
    },
    {
    .iv = 250,
    .lvl = 26,
...
static const struct TrainerMon sParty_Flannery1[] = {
	...
	.ability = ABILITY_SLOT_1,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYPNOSIS, MOVE_ICY_WIND, MOVE_BRICK_BREAK, MOVE_SCALD}
    },
    {
    .iv = 200,
    .lvl = 27,
	...
	.ability = ABILITY_SLOT_2,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HAZE, MOVE_YAWN, MOVE_BULLDOZE, MOVE_SCALD}
    },
    {
    .iv = 250,
    .lvl = 28,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SPIDER_WEB, MOVE_CRUNCH, MOVE_X_SCISSOR, MOVE_SCALD}
    },
    {
    .iv = 250,
    .lvl = 30,
	...
	.ability = ABILITY_HIDDEN,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_CALM_MIND, MOVE_FLAMETHROWER, MOVE_PSYSHOCK, MOVE_SCALD}
    }
};
...
static const struct TrainerMon sParty_Norman1[] = {
	...
	.ability = ABILITY_SLOT_1,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SUNNY_DAY, MOVE_AMNESIA, MOVE_EARTH_POWER, MOVE_LAVA_PLUME}
    },
    {
    .iv = 200,
    .lvl = 31,
	...
	.ability = ABILITY_SLOT_2,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_NIGHT_SLASH, MOVE_THUNDER_PUNCH, MOVE_GIGA_DRAIN, MOVE_OVERHEAT}
    },
    {
    .iv = 200,
    .lvl = 32,
	...
	.ability = ABILITY_SLOT_2,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_SUNNY_DAY, MOVE_SLUDGE_BOMB, MOVE_DARK_PULSE, MOVE_OVERHEAT}
    },
    {
    .iv = 250,
    .lvl = 34,
    ...
    .moves = {MOVE_SCREECH, MOVE_WILD_CHARGE, MOVE_LEECH_LIFE, MOVE_FLARE_BLITZ}
    }
};
...
static const struct TrainerMon sParty_Winona1[] = {
	...
	.ability = ABILITY_SLOT_1,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_STEALTH_ROCK, MOVE_SHELL_SMASH, MOVE_ROCK_BLAST, MOVE_X_SCISSOR}
    },
    {
    .iv = 210,
    .lvl = 38,
	...
	.ability = ABILITY_SLOT_2,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TOXIC, MOVE_EARTHQUAKE, MOVE_POISON_JAB, MOVE_X_SCISSOR}
    },
    {
    .iv = 220,
    .lvl = 39,
    ...
    .moves = {MOVE_U_TURN, MOVE_STEEL_WING, MOVE_BUG_BITE, MOVE_DUAL_CHOP}
    },
    {
    .iv = 255,
    .lvl = 41,
    ...
    .moves = {MOVE_U_TURN, MOVE_GIGA_DRAIN, MOVE_AIR_SLASH, MOVE_BUG_BUZZ}
    }
};
...
static const struct TrainerMon sParty_TateAndLiza1[] = {
    ...
    .moves = {MOVE_FREEZE_DRY, MOVE_EARTH_POWER, MOVE_POWER_GEM, MOVE_BLIZZARD}
    },
    {
    .iv = 210,
    .lvl = 46,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SUBSTITUTE, MOVE_WILL_O_WISP, MOVE_HEX, MOVE_BLIZZARD}
    },
    {
    .iv = 220,
    .lvl = 47,
	...
	.ability = ABILITY_SLOT_2,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FREEZE_DRY, MOVE_ROCK_SLIDE, MOVE_BULLDOZE, MOVE_ICICLE_CRASH}
    },
    {
    .iv = 255,
    .lvl = 49,
    ...
    .heldItem = ITEM_MUSCLE_BAND,
    .moves = {MOVE_ICE_SHARD, MOVE_POISON_JAB, MOVE_KNOCK_OFF, MOVE_ICICLE_CRASH}
    }
};
...
static const struct TrainerMon sParty_Juan1[] = {
    ...
    .moves = {MOVE_STEALTH_ROCK, MOVE_EXPLOSION, MOVE_EARTHQUAKE, MOVE_ROCK_BLAST}
    },
    {
    .iv = 200,
    .lvl = 54,
	...
	.ability = ABILITY_SLOT_2,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_STICKY_WEB, MOVE_TOXIC, MOVE_INFESTATION, MOVE_KNOCK_OFF}
    },
    {
    .iv = 200,
    .lvl = 55,
	...
	.ability = ABILITY_HIDDEN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRAGON_DANCE, MOVE_EARTHQUAKE, MOVE_DRAGON_CLAW, MOVE_HEAD_SMASH}
    },
    {
    .iv = 200,
    .lvl = 55,
	...
	.ability = ABILITY_SLOT_1,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HONE_CLAWS, MOVE_EARTHQUAKE, MOVE_STONE_EDGE, MOVE_BRAVE_BIRD}
    },
    {
    .iv = 250,
    .lvl = 57,
    ...
    .heldItem = ITEM_EXPERT_BELT,
    .moves = {MOVE_ICE_PUNCH, MOVE_SUPERPOWER, MOVE_CRUNCH, MOVE_STONE_EDGE}
    }
};

static const struct TrainerMon sParty_GRC_Johnny1[] = {
    {
    .iv = 10,
    .lvl = 14,
    ...
    .iv = 10,
    .lvl = 14,
    .species = SPECIES_GULPIN_HANAUAN,
    },
    {
    .iv = 10,
    .lvl = 15,
...
//to fix
static const struct TrainerMon sParty_GRC_Johnny2[] = {
    {
    .iv = 20,
    .lvl = 26,
    .species = SPECIES_RALTS,
...
//to fix
static const struct TrainerMon sParty_GRC_Johnny3[] = {
    {
    .iv = 30,
    .lvl = 29,
    .species = SPECIES_KIRLIA,
...
//to fix
static const struct TrainerMon sParty_GRC_Johnny4[] = {
    {
    .iv = 40,
    .lvl = 32,
    .species = SPECIES_KIRLIA,
...
//to fix
static const struct TrainerMon sParty_GRC_Johnny5[] = {
    {
    .iv = 50,
    .lvl = 34,
    .species = SPECIES_KIRLIA,
...
static const struct TrainerMon sParty_GRC_Helen1[] = {
    {
    .iv = 10,
    .lvl = 15,
    .species = SPECIES_GULPIN_HANAUAN,
...
//to fix
static const struct TrainerMon sParty_GRC_Helen2[] = {
    {
    .iv = 20,
    .lvl = 26,
    .species = SPECIES_SHROOMISH,
...
//to fix
static const struct TrainerMon sParty_GRC_Helen3[] = {
    {
    .iv = 30,
    .lvl = 29,
    .species = SPECIES_SHROOMISH,
...
//to fix
static const struct TrainerMon sParty_GRC_Helen4[] = {
    {
    .iv = 40,
    .lvl = 32,
    .species = SPECIES_BRELOOM,
...
//to fix
static const struct TrainerMon sParty_GRC_Helen5[] = {
    {
    .iv = 50,
    .lvl = 35,
    .species = SPECIES_BRELOOM,
...
static const struct TrainerMon sParty_GRC_Harold1[] = {
    {
    .iv = 0,
    .lvl = 14,
    .species = SPECIES_TENTACOOL,
...
//To fix
static const struct TrainerMon sParty_GRC_Harold2[] = {
    {
    .iv = 0,
    .lvl = 29,
    .species = SPECIES_SKITTY,
...
//To fix
static const struct TrainerMon sParty_GRC_Harold3[] = {
    {
    .iv = 0,
    .lvl = 32,
    .species = SPECIES_SKITTY,
...
//To fix
static const struct TrainerMon sParty_GRC_Harold4[] = {
    {
    .iv = 0,
    .lvl = 35,
    .species = SPECIES_DELCATTY,
...
//To fix
static const struct TrainerMon sParty_GRC_Harold5[] = {
    {
    .iv = 0,
    .lvl = 38,
    .species = SPECIES_DELCATTY,
...
static const struct TrainerMon sParty_GRC_Li[] = {
    {
    .iv = 100,
    .lvl = 12,
    .species = SPECIES_MAKUHITA,
...
static const struct TrainerMon sParty_GRC_Ken[] = {
    {
    .iv = 110,
    .lvl = 11,
    .species = SPECIES_TIMBURR,
...
static const struct TrainerMon sParty_GRC_Zhen[] = {
    {
    .iv = 0,
    .lvl = 15,
    .species = SPECIES_TIMBURR,
...
static const struct TrainerMon sParty_Wallace[] = {
	...
	.ability = ABILITY_HIDDEN,
    .heldItem = ITEM_BLACK_SLUDGE,
    .moves = {MOVE_TOXIC_SPIKES, MOVE_HAZE, MOVE_RECOVER, MOVE_KNOCK_OFF}
    },
    {
    .iv = 255,
    .lvl = 68,
    ...
    .heldItem = ITEM_ROCKY_HELMET,
    .moves = {MOVE_WILL_O_WISP, MOVE_PROTECT, MOVE_PSYCHIC, MOVE_HEX}
    },
    {
    .iv = 255,
    .lvl = 68,
	...
	.ability = ABILITY_SLOT_2,
    .heldItem = ITEM_WISE_GLASSES,
    .moves = {MOVE_U_TURN, MOVE_FIRE_BLAST, MOVE_HURRICANE, MOVE_DRACO_METEOR}
    },
    {
    .iv = 255,
    .lvl = 68,
    ...
    .moves = {MOVE_CURSE, MOVE_REST, MOVE_CRUNCH, MOVE_BODY_SLAM}
    },
    {
    .iv = 255,
    .lvl = 68,
    ...
    .moves = {MOVE_DRAGON_DANCE, MOVE_CRUNCH, MOVE_STONE_EDGE, MOVE_WATERFALL}
    },
    {
    .iv = 255,
    .lvl = 70,
    ...
    .moves = {MOVE_SWORDS_DANCE, MOVE_ICE_PUNCH, MOVE_ZEN_HEADBUTT, MOVE_CLOSE_COMBAT}
    }
};

static const struct TrainerMon sParty_GRC_Jennifer[] = {
    {
    .iv = 0,
    .lvl = 13,
    .species = SPECIES_RALTS,
...
static const struct TrainerMon sParty_GRC_Kyle[] = {
    {
    .iv = 0,
    .lvl = 5,
    .species = SPECIES_LILLIPUP,
...
static const struct TrainerMon sParty_GRC_JimAndJo1[] = {
    {
    .iv = 0,
    .lvl = 14,
...
//To fix
static const struct TrainerMon sParty_GRC_JimAndJo2[] = {
    {
    .iv = 10,
    .lvl = 27,
    .species = SPECIES_PLUSLE,
...
//To fix
static const struct TrainerMon sParty_GRC_JimAndJo3[] = {
    {
    .iv = 0,
    .lvl = 9,
    .species = SPECIES_PLUSLE,
...
//To fix
static const struct TrainerMon sParty_GRC_JimAndJo4[] = {
    {
    .iv = 20,
    .lvl = 30,
    .species = SPECIES_PLUSLE,
...
//To fix
static const struct TrainerMon sParty_GRC_JimAndJo5[] = {
    {
    .iv = 30,
    .lvl = 33,
    .species = SPECIES_PLUSLE,
...
//To fix
static const struct TrainerMon sParty_GRC_JimAndJo6[] = {
    {
    .iv = 40,
    .lvl = 36,
    .species = SPECIES_PLUSLE,
...
static const struct TrainerMon sParty_GRC_MegAndMia[] = {
    {
    .iv = 0,
    .lvl = 11,
    .species = SPECIES_LILLIPUP,
...
static const struct TrainerMon sParty_GRC_BasilTurpiaMudkip[] = {
    {
    .iv = 0,
    .lvl = 5,
...
static const struct TrainerMon sParty_GRC_BasilPoppyMudkip[] = {
    {
    .iv = 50,
    .lvl = 14,
    .species = SPECIES_STARAVIA,
	.ability = ABILITY_HIDDEN,
	.moves = {MOVE_QUICK_ATTACK, MOVE_WING_ATTACK, MOVE_DOUBLE_TEAM, MOVE_GROWL}
    },
    {
    .iv = 100,
    .lvl = 16,
	...
	.heldItem = ITEM_ORAN_BERRY,
	.moves = {MOVE_LEER, MOVE_QUICK_ATTACK, MOVE_FURY_CUTTER, MOVE_MEGA_DRAIN}
    }
};
...
static const struct TrainerMon sParty_GRC_BasilTurpiaTreecko[] = {
    {
    .iv = 0,
    .lvl = 5,
...
static const struct TrainerMon sParty_GRC_BasilPoppyTreecko[] = {
    {
    .iv = 50,
    .lvl = 14,
    .species = SPECIES_STARAVIA,
...
static const struct TrainerMon sParty_GRC_BasilTurpiaTorchic[] = {
    {
    .iv = 0,
    .lvl = 5,
...
static const struct TrainerMon sParty_GRC_BasilPoppyTorchic[] = {
    {
    .iv = 50,
    .lvl = 14,
    .species = SPECIES_STARAVIA,
	...
	.heldItem = ITEM_ORAN_BERRY,
	.moves = {MOVE_PROTECT, MOVE_ROCK_THROW, MOVE_WATER_GUN, MOVE_MUD_SHOT}
    }
};
...
static const struct TrainerMon sParty_GRC_AlyssaTurpiaMudkip[] = {
    {
    .iv = 0,
    .lvl = 5,
    .species = SPECIES_TREECKO,
...
static const struct TrainerMon sParty_GRC_AlyssaPoppyMudkip[] = {
    {
    .iv = 50,
    .lvl = 14,
    .species = SPECIES_STARAVIA,
...
static const struct TrainerMon sParty_GRC_AlyssaTurpiaTreecko[] = {
    {
    .iv = 0,
    .lvl = 5,
    .species = SPECIES_TORCHIC,
...
static const struct TrainerMon sParty_GRC_AlyssaPoppyTreecko[] = {
    {
    .iv = 50,
    .lvl = 14,
    .species = SPECIES_STARAVIA,
...
static const struct TrainerMon sParty_GRC_AlyssaTurpiaTorchic[] = {
    {
    .iv = 0,
    .lvl = 5,
    .species = SPECIES_MUDKIP,
...
static const struct TrainerMon sParty_GRC_AlyssaPoppyTorchic[] = {
    {
    .iv = 50,
    .lvl = 14,
    .species = SPECIES_STARAVIA,
...
static const struct TrainerMon sParty_GRC_ToriTurpiaMudkip[] = {
    {
    .iv = 0,
    .lvl = 5,
    .species = SPECIES_TORCHIC,
...
static const struct TrainerMon sParty_GRC_ToriTurpiaTreecko[] = {
    {
    .iv = 0,
    .lvl = 5,
    .species = SPECIES_MUDKIP,
...
static const struct TrainerMon sParty_GRC_ToriTurpiaTorchic[] = {
    {
    .iv = 0,
    .lvl = 5,
    .species = SPECIES_TREECKO,
...
static const struct TrainerMon sParty_GRC_AndiAndMai[] = {
    {
    .iv = 120,
    .lvl = 12,
    .species = SPECIES_MAKUHITA,
...
static const struct TrainerMon sParty_GRC_Benny[] = {
    {
    .iv = 0,
    .lvl = 13,
...
static const struct TrainerMon sParty_GRC_Morris[] = {
    {
    .iv = 0,
    .lvl = 9,
    .species = SPECIES_SHROOMISH,
...
static const struct TrainerMon sParty_GRC_Corey[] = {
    {
    .iv = 50,
    .lvl = 14,
    .species = SPECIES_SURSKIT,
...
static const struct TrainerMon sParty_GRC_Wayne1[] = {
    {
    .iv = 0,
    .lvl = 9,
    .species = SPECIES_PARAS,
...
//TO FIX
static const struct TrainerMon sParty_GRC_Wayne2[] = {
    {
    .iv = 10,
    .lvl = 27,
    .species = SPECIES_NINJASK,
...
//TO FIX
static const struct TrainerMon sParty_GRC_Wayne3[] = {
    {
    .iv = 20,
    .lvl = 29,
    .species = SPECIES_DUSTOX,
...
//TO FIX
static const struct TrainerMon sParty_GRC_Wayne4[] = {
    {
    .iv = 30,
    .lvl = 31,
    .species = SPECIES_SURSKIT,
...
//TO FIX
static const struct TrainerMon sParty_GRC_Wayne5[] = {
    {
    .iv = 40,
    .lvl = 33,
    .species = SPECIES_SURSKIT,
...
static const struct TrainerMon sParty_GRC_Gabriel[] = {
    {
    .iv = 0,
    .lvl = 14,
    .species = SPECIES_PSYDUCK_HANAUAN,
...
static const struct TrainerMon sParty_GRC_ToriAndTia[] = {
    {
    .iv = 0,
    .lvl = 19,
    .species = SPECIES_SPINDA,
...
static const struct TrainerMon sParty_GRC_Rudy[] = {
    {
    .iv = 0,
    .lvl = 13,
    .species = SPECIES_ZUBAT
    ...
    .iv = 0,
    .lvl = 14,
    .species = SPECIES_WHISMUR_HANAUAN
    }
};

static const struct TrainerMon sParty_GRC_Vera[] = {
    {
    .iv = 0,
    .lvl = 13,
    .species = SPECIES_NINCADA,
...
static const struct TrainerMon sParty_GRC_Finn[] = {
    {
    .iv = 0,
    .lvl = 10,
    .species = SPECIES_MAGIKARP,
...
static const struct TrainerMon sParty_GRC_Alyssa[] = {
    {
    .iv = 0,
    .lvl = 15,
    .species = SPECIES_MAGNEMITE,
...
static const struct TrainerMon sParty_GRC_Rodd[] = {
    {
    .iv = 100,
    .lvl = 13,
    .species = SPECIES_PARAS,
...
static const struct TrainerMon sParty_GRC_Sally[] = {
    {
    .iv = 100,
    .lvl = 13,
    .species = SPECIES_RALTS,
...
static const struct TrainerMon sParty_GRC_Alliah[] = {
    {
    .iv = 0,
    .lvl = 30,
    .species = SPECIES_GARDEVOIR,
...
static const struct TrainerMon sParty_GRC_Kwok[] = {
    {
    .iv = 0,
    .lvl = 30,
    .species = SPECIES_GALLADE,
...
static const struct TrainerMon sParty_GRC_Pete[] = {
    {
    .iv = 0,
    .lvl = 13,
