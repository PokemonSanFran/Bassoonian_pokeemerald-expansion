...
const u16 gSpeciesToNationalPokedexNum[NUM_SPECIES] = // Assigns all species to the National Dex Index (Summary No. for National Dex)
{
	...
	[SPECIES_GULPIN_HANAUAN - 1] = NATIONAL_DEX_GULPIN,
	[SPECIES_SWALOT_HANAUAN - 1] = NATIONAL_DEX_SWALOT,
	[SPECIES_WHISMUR_HANAUAN - 1] = NATIONAL_DEX_WHISMUR,
	[SPECIES_LOUDRED_HANAUAN - 1] = NATIONAL_DEX_LOUDRED,
	[SPECIES_EXPLOUD_HANAUAN - 1] = NATIONAL_DEX_EXPLOUD,
    [SPECIES_CROAGUNK_HANAUAN - 1] = NATIONAL_DEX_CROAGUNK,
    [SPECIES_TOXICROAK_HANAUAN - 1] = NATIONAL_DEX_TOXICROAK,
};
...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_FINNEON_HANAUAN - 1]       = ANIM_SWING_CONVEX,
    [SPECIES_LUMINEON_HANAUAN - 1]      = ANIM_V_SLIDE_WOBBLE,
    ...
    [SPECIES_EXPLOUD_HANAUAN - 1]       = ANIM_GROW_STUTTER_TWICE,
    [SPECIES_CROAGUNK_HANAUAN - 1]      = ANIM_V_SLIDE_WOBBLE,
    [SPECIES_TOXICROAK_HANAUAN - 1]     = ANIM_CIRCULAR_VIBRATE,
};
...
{
    {FACILITY_CLASS_YOUNGSTER, FACILITY_CLASS_BUG_CATCHER, FACILITY_CLASS_RICH_BOY, FACILITY_CLASS_CAMPER, FACILITY_CLASS_ACE_TRAINER_M},
    {FACILITY_CLASS_LASS, FACILITY_CLASS_SCHOOL_KID_F, FACILITY_CLASS_LADY, FACILITY_CLASS_PICNICKER, FACILITY_CLASS_ACE_TRAINER_F}
};
...
void CreateBoxMon(struct BoxPokemon *boxMon, u16 species, u8 level, u8 fixedIV, u8 hasFixedPersonality, u32 fixedPersonality, u8 otIdType, u32 fixedOtId)
{
    ...
    else
    {
        ...
        //If flag is set, make three random IVs flawless
        if (FlagGet(FLAG_SYS_FORCE3IVS))
        {
